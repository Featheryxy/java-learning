...
//        }
    ...
    public void test1(){
        ...
        students.add(new Teacher("dava"));
        coll(students);
    }


    public <T>  void coll(Collection<T> peoples) {
        if (peoples instanceof ArrayList) {
            ArrayList<Student> arrayList = (ArrayList<Student>) peoples;
